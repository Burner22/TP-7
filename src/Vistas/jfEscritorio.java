...
public class jfEscritorio extends javax.swing.JFrame {
    private HashSet <Materia> totalMat = new HashSet <> ();
    private HashSet <Alumno> totAlu = new HashSet <> ();
    ...
    private void initComponents() {
        ...
        jMenu1.setText("Alta de Materias");

        jMenuItem2.setText("Alta de Materia");
        ...
        jMenu2.setText("Alta de Alumnos");

        jMenuItem1.setText("Alta de Alumno");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        escritorio.repaint();
        jiAltaMateria mat = new jiAltaMateria (totalMat);
        mat.setVisible(true);
        escritorio.add(mat);
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        escritorio.removeAll();
        escritorio.repaint();
        jiAltaAlumno alu = new jiAltaAlumno (totAlu);
        alu.setVisible(true);
        escritorio.add(alu);
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        escritorio.removeAll();
        escritorio.repaint();
        jiInscripcion ins = new jiInscripcion (totalMat, totAlu);
        ins.setVisible(true);
        escritorio.add(ins);
